  ...
  return (
    <section className="relative tapestry-onyx-grain">
      ...
      <div className="pointer-events-none absolute inset-x-0 -top-10 flex justify-center">
        <div className="relative h-40 w-40 opacity-10">
          <svg viewBox="0 0 1 1" className="h-full w-full">
            <image href="/ethenic-glitz-logo.png" height="1" width="1" preserveAspectRatio="xMidYMid meet" />
          </svg>
        </div>
      </div>
      <div className="mx-auto max-w-5xl px-6 py-28 sm:py-36">
        ...
        >
          Heritage-inspired imitation jewellery with ornate silhouettes and timeless statement styling.
        </motion.p>
        <motion.div
          className="mt-10"
          initial={{ opacity: 0 }}
