        ...
        <div className="mx-auto max-w-[1920px] px-4 lg:px-12">
          ...
          <div className="flex lg:hidden items-center justify-between h-14 relative z-50 bg-white">
            ...
            <Link href="/" className="flex items-center gap-2 group">
              <div className="relative h-9 w-9 overflow-hidden rounded-lg shadow-sm group-hover:shadow-md transition-shadow duration-300">
                <Image
                  src="/ethenic-glitz-logo.png"
                  alt="Ethenic Glitz Logo"
                  fill
                  sizes="36px"
              ...
              <span className="text-base font-serif tracking-[0.15em] text-gray-900 uppercase">Ethenic Glitz</span>
            </Link>
            ...
            <div className="flex justify-between items-center h-16 relative">
              ...
              <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
                <Link href="/" className="flex items-center gap-3 group">
                  <span className="text-lg font-serif tracking-[0.15em] text-gray-900 uppercase group-hover:text-brilliant-green transition-colors duration-500">
                    Ethenic
                  </span>
                  <div className="relative h-12 w-12 overflow-hidden rounded-xl shadow-sm transition-all duration-500 group-hover:scale-105 group-hover:shadow-md">
                    <Image
                      src="/ethenic-glitz-logo.png"
                      alt="Ethenic Glitz Logo"
                      fill
