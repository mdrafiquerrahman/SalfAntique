...
const QUESTIONS = [
  { 
    field: "purpose", 
    question: "Greetings. I am your Ethenic Glitz curator. How may I assist you today?",
          ...
          >
            ...
            <div className="flex items-center justify-between bg-white px-6 py-5 border-b border-gray-100">
              <div className="flex items-center gap-4">
                <div className="relative h-12 w-12 overflow-hidden rounded-xl shadow-sm border border-gray-100">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img src="/ethenic-glitz-logo.png" alt="Logo" className="h-full w-full object-cover" />
                  <div className="absolute bottom-0.5 right-0.5 h-2.5 w-2.5 rounded-full border-2 border-white bg-green-500" />
                </div>
                <div>
                  <h3 className="font-serif text-[13px] font-semibold tracking-widest text-gray-900 uppercase">Ethenic Glitz Curator</h3>
            ...
            {!isComplete && (
              <div className="bg-white px-6 pb-6">
                ...
                <div className="mt-3 flex flex-col items-center gap-2">
                  <span className="text-[10px] font-bold tracking-[0.2em] text-gray-300 uppercase">or</span>
                  <a 
                    href="https://wa.me/917977556989" 
                    target="_blank" 
                    rel="noopener noreferrer"
                  ...
                  <p className="text-center text-[9px] font-medium tracking-[0.2em] text-gray-300 uppercase">
                    Exquisite Service • Ethenic Glitz
                  </p>
                </div>
              </div>
            )}
