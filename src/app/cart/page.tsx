...
export default function CartPage() {
  ...
  const trustDetails: Record<string, { title: string, content: string }> = {
    ...
    "100% Authentic": {
      ...
      content: "Every item in the Ethenic Glitz collection undergoes rigorous appraisal by our master curators. We provide a physical Certificate of Authenticity detailing the era, materials, and historical origin of your treasure."
    },
    "Easy Returns": {
